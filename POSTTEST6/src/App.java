...
abstract class Rafaalpaper implements Displayable {
    final String nama;
    final String tema;
    final int harga;
...
public class App {
    static final ArrayList<Rafaalpaper> rafaalpapers = new ArrayList<>();
    ...
    static void tambah_wallpaper() {
        try {
            ...
            System.out.println("Input harus berupa angka untuk harga.");
    ...
    static void tampilkan_wallpaper() {
        ...
        for (int i = 0; i < rafaalpapers.size(); i++) {
            ...
            rafaalpapers.get(i).displayInfo();
            rafaalpapers.get(i).displayType();
            System.out.println("---------------------------");
        }
    }
